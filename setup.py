...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_information_uom',
    download_url='https://github.com:nantic/trytond-product_information_uom.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_information_uom.git'
    },
    classifiers=[
